...
export interface ICryptoDetails {
	...
	detail_platforms: TDetailPlatforms;
...
export interface TDetailPlatforms {
	'': TGeneratedType;
}

export interface TGeneratedType {
...
export interface IcoData {
	...
	amount_for_sale: string;
	kyc_required: boolean;
	whitelist_available: string;
	pre_sale_available: string;
...
export interface MarketData {
	...
	price_change_percentage_1y_in_currency: TPriceChangePercentage1yInCurrency;
	market_cap_change_24h_in_currency: TMarketCapChange24hInCurrency;
...
export type TPriceChangePercentage1yInCurrency = {
	aed: number;
	ars: number;
	aud: number;
	bch: number;
...
export type TMarketCapChange24hInCurrency = {
	aed: number;
	ars: number;
	aud: number;
	bch: number;
...
export interface ICryptoChartData {
